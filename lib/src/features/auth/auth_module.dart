...
import 'package:org_eventos_app/src/features/auth/presentation/view/page/verification_code_page.dart';
...
import 'presentation/view/page/reset_password_page.dart';
...
class AuthModule extends Module {
  ...
  List<ModularRoute> get routes => [
        ...
        ChildRoute('/verification-code', child: (_, __) => const VerificationCodePage()),
